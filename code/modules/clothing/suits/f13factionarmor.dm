...
/obj/item/clothing/suit/armor/f13/legion/recruit
	...
	armor = list("melee" = 33, "bullet" = 25, "laser" = 20, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
	slowdown = 0.04
...
/obj/item/clothing/suit/armor/f13/legion/prime
	...
	armor = list("melee" = 35, "bullet" = 33, "laser" = 20, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/legion/centurion
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 55)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/palacent
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 60, "energy" = 25, "bomb" = 35, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 55)
	slowdown = 0.25
...
/obj/item/clothing/suit/armor/f13/legion/rangercent
	...
	armor = list("melee" = 35, "bullet" = 60, "laser" = 35, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 55)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/f13/metalarmor/steelbib/oasis
	...
	armor = list( "melee" = 35, "bullet" = 50, "laser" = 40, "energy" = 15, "bomb" = 20, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 42)
	slowdown = 0.11
	strip_delay = 5
